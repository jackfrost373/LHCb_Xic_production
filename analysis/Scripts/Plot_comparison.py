...
from analysis.Scripts.Imports import SWEIGHTS_PATH
...
def plot_comparison(varname, tree1, tree2, bins=100, cuts1 = "1==1", cuts2 = "1==1", extralabel1="", extralabel2="", normalized=True, legendLocation="Right", Yaxis_range_1=0, Yaxis_range_2=1000, Override = False, xmin=0, xmax=0) :
    ...
    fileloc=SWEIGHTS_PATH + "/2018_MagDown/Xic_total_sWeight_swTree.root"
    ...
    #tree1.AddFriend("dataNew",SWEIGHTS_PATH+"/2018_MagDown/Xic_total_sWeight_swTree.root")
