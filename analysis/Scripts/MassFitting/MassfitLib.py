...
#Does exactly the same as the function above, but you just need to give the full path
#of the data file, the function will parse the important information from it
#it is important that the data file is arranged in a structure like this:
#   .../year_MagPol/bins/file.root
def Shape_fit_fullPath(shape,fittingDict,fullPath):
