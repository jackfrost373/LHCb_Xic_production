...
def setBranch_funct (root_file, extra_variable):
    ...
    useful_vars = ["lcplus_MM", "lcplus_P", "lcplus_PT", "lcplus_ETA", "lcplus_RAPIDITY", "lcplus_TIP", "lcplus_IPCHI2_OWNPV", "lcplus_L0Global_TOS", "lcplus_Hlt1Global_TOS", "lcplus_Hlt2Global_TOS", "lcplus_Hlt1Phys_TOS", "lcplus_Hlt2Phys_TOS", "lcplus_Hlt1TrackAllL0Decision_TOS", "lcplus_L0HadronDecision_TOS", "lcplus_Hlt2CharmHadD2HHHDecision_TOS", "pplus_P", "pplus_PT", "pplus_RAPIDITY", "pplus_ETA", "piplus_P", "piplus_PT", "piplus_RAPIDITY", "piplus_ETA", "kminus_P", "kminus_PT", "kminus_RAPIDITY", "kminus_ETA", "PVNTRACKS"] # list of variables kept in the tree
