...
x     = ROOT.RooRealVar("x","x",0,250)
mu    = ROOT.RooRealVar("mu","mu",125,50,250)
sigma = ROOT.RooRealVar("sigma","sigma",20,0,40)
...
if( fit == "ipatia" ) :
  ...
  ROOT.gROOT.ProcessLine(".L src/RooIpatia2_cxx.d")
...
####################
  ...
  Bukin_Xp   = ROOT.RooRealVar("Bukin_Xp", "Peak position",125,0,200 )
  Bukin_Sigp = ROOT.RooRealVar("Bukin_Sigp", "Peak width", 20,0,40)
